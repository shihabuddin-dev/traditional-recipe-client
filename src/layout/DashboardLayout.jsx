        ...
        <div className="min-h-screen bg-base-100 flex flex-col md:flex-row">
            ...
            <aside id="dashboard-sidebar" className="hidden w-full md:w-64 bg-base-200 border-r border-orange-100 md:flex flex-col items-center py-8 px-4 md:fixed md:h-full z-20">
                ...
                <nav className="flex flex-col gap-3 w-full">
                    ...
                    <NavLink to="/dashboard/my-profile" onClick={closeSidebarOnMobile} className={({ isActive }) => `flex items-center gap-2 px-4 py-2 rounded-full font-medium transition ${isActive ? 'bg-orange-100 text-orange-600' : 'hover:bg-orange-50 hover:text-black text-base-content'}`}> <FaUserCircle /> My Profile </NavLink>
