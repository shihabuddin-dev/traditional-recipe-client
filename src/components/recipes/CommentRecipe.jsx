...
const CommentRecipe = ({
  ...
  return (
    <div className="mb-10 bg-base-100 rounded-2xl shadow-sm p-8 mt-6 border border-orange-400  ">
        ...
        {comments.length > 0 &&
          comments.map((comment) => {
            ...
            return (
              <div
                key={comment.id}
                className="flex flex-col bg-base-100 rounded-xl p-4 shadow  h-full border border-orange-300  "
              >
