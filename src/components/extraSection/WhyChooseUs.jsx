      ...
      <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
        {features.map((f, i) => (
          <Fade key={i} direction={i % 2 === 0 ? "down" : "right"} triggerOnce>
            <div
              key={i}
              className="bg-base-100 border border-orange-200 rounded-2xl shadow-sm p-8 flex flex-col items-center hover:shadow-md transition-shadow-xs duration-800 hover:bg-base-200 hover:-translate-y-3"
            >
              {f.icon}
